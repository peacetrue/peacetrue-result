...
/**
 * {@link ClientInvalidException} 异常转换器。
 *
 * @author peace
 **/
public class ClientInvalidExceptionConverter
        extends AbstractExceptionConverter<ClientInvalidException>
    ...
    @Nullable
    @Override
    protected Object resolveArgs(ClientInvalidException exception) {
